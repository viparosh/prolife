  ...
  return (
    <>
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => notifyAll()} className="rounded-md bg-primary p-2 px-6 text-white">
          Notify All
        </button>
      </div>
      ...
      <p className="mb-20 rounded-md p-3 bg-[#FFEDD5] text-gray-700 text-center text-sm w-full">
