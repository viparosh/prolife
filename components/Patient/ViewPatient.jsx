        ...
        <div className="grid gap-10 xl:grid-cols-3">
          ...
          <div>
            <div className="mt-2 border-b-2 border-solid border-slate-370 pb-4">
              ...
              <p className="my-2 ">
                <span className="text-[#534D6D]">Birth Date:&nbsp;&nbsp;</span>
                {data?.birthDate &&
                  moment(data?.birthDate).format('MMM DD ,YYYY')}
              </p>
              <p className="my-2">
                <span className="text-[#534D6D]">Birth Place:&nbsp;&nbsp;</span>
                {data?.birthPlace}
              </p>
              <p className="my-2 capitalize">
                <span className="text-[#534D6D]">Religion:&nbsp;&nbsp;</span>
                {data?.religion}
              </p>
              <p className="my-2">
                <span className="text-[#534D6D]">Nationality:&nbsp;&nbsp;</span>
                {data?.nationality}
              </p>
              <p className="my-2">
                <span className="text-[#534D6D]">Occupation:&nbsp;&nbsp;</span>
                {data?.occupation}
              </p>
            </div>
            <div className="mt-2 border-b-2 border-solid border-slate-370 pb-4">
              ...
              <p className="my-2 capitalize">
                <span className="text-[#534D6D]">Name:&nbsp;&nbsp;</span>
              ...
              <p className="my-2">
                <span className="text-[#534D6D]">Age:&nbsp;&nbsp;</span>
                {data?.spouse_age}
              </p>
              <p className="my-2 capitalize">
                <span className="text-[#534D6D]">Occupation:&nbsp;&nbsp;</span>
          ...
          <div>
            <div className="mt-2 border-b-2 border-solid border-slate-370 pb-4">
              ...
              <p className="my-2">
                <span className="text-[#534D6D]">No. of previous pregnancies:&nbsp;&nbsp;</span>
                {data?.no_previousPregnancies}
              </p>
              <p className="my-2">
                <span className="text-[#534D6D]">Previous Caesarians:&nbsp;&nbsp;</span>
                {data?.previousCaesareans}
              </p>
              <p className="my-2">
                <span className="text-[#534D6D]">3 Consecutive Miscarriages:&nbsp;&nbsp;</span>
                {data?.consecutiveMiscarriages}
              </p>
              <p className="my-2">
                <span className="text-[#534D6D]">Postpartum Hemorrhage:&nbsp;&nbsp;</span>
            ...
            <div className="mt-2 border-b-2 border-solid border-slate-370 pb-4">
              ...
              <p className="my-2">
                <span className="text-[#534D6D]">Contact #:&nbsp;&nbsp;</span>
                {data?.emergencyContact}
              </p>
              <p className="my-2">
                <span className="text-[#534D6D]">Address:&nbsp;&nbsp;</span>
