...
const SessionForm = ({
  ...
  return (
    <div className="fixed top-0 left-0 z-30 flex h-screen w-screen items-center justify-center bg-black/50">
      <div className="scrollbar-thin scrollbar-thumb-slate-400 scrollbar-track-slate-200 relative flex max-h-patientModal w-full max-w-sessionModal flex-col  justify-between overflow-auto rounded-md bg-white">
        <div>
          {/* header  */}
          <div className="sticky left-0 top-0 z-10 bg-white py-6 px-4">
            ...
            <div className=" py-2 sm:p-4">
              <ul className="m-0 sm:flex sm:flex-row grid grid-cols-2 gap-4 flex-wrap">
