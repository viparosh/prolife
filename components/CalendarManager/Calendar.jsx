            ...
            <button
              className={`${
                moment(renderDate(item, currentMonth)).format('ddd') == 'Sun'
                  ...
                  : 'text-slate-900 hover:text-white hover:bg-slate-400'
              }  duration-400 m-1 inline-block h-10 w-10 cursor-pointer rounded-full p-2 text-cente transition-colors`}
              onClick={() =>
                moment(renderDate(item, currentMonth)).format('ddd') != 'Sun' &&
