    ...
    <NoLayout>
      <div className="flex h-full w-full items-center justify-center">
        ...
        <div className="md:flex p-7 flex-col h-full w-[70rem]">
          ...
          <div className="lg:mt-[6rem] sm:mt-[2rem] w-full lg:p-12 p-5  lg:flex-shrink flex flex-col gap-4 rounded-md">
            ...
            <div className="flex space-x-2 flex-row">
              <button onClick={() => submitHandler()} className="w-1/2 cursor-pointer text-sm rounded-full bg-[#8D5A63] py-3  px-4 text-white">
                Sign in
              </button>
              <button onClick={() => setNeedModal(true)} className="w-1/2 cursor-pointer rounded-full text-sm bg-[#0F1815] py-3  px-4 text-white">
                Need an account ?
              </button>
            </div>
          </div>
        ...
        <div className="lg:flex flex-shrink w-full px-20 py-7 hidden flex-col h-screen bg-[#625B7D]">
          ...
          <p className="lg:mt-2 text-white text-sm">
