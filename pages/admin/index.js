  ...
  return (
    <Layout title="Dashboard" role="Admin">
      <div className="w-full flex flex-col 2xl:flex-row gap-10">
        ...
        <div className=" w-full h-full grid xl:grid-cols-2 gap-2 lg:grid-cols-1">
          ...
          <div className="w-full p-4 rounded-md bg-orange-100">
            ...
            <Link href="../cancellation/server">
              <button className="bg-orange-800 text-sm font-medium rounded-md px-4 py-2 text-white w-full">Continue</button>
            </Link>
          </div>
          
        </div>

        <div className="w-full 2xl:w-[29rem] py-4">
          <div className="flex items-center justify-between mb-5">
            <p className="sticky top-0 bg-white font-semibold text-gray-700">System Logs</p>
            <button className="text-sm text-white py-1 px-5 rounded-md border bg-[#8D5A63]"onClick={() => setShowLogs(!showLogs)}>
              { showLogs ? <p>Hide</p> : <p>Show</p> }
            </button>  
          </div>
          {showLogs ? 
          ...
          : 
          <div className="text-center p-4 bg-gray-200 rounded-md flex items-center justify-center w-full text-sm">Logs are hidden.</div>
          }
