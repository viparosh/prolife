...
function appointment() {
  ...
  const submitHandler = async () => {
    ...
    if (isEmpty) {
      console.log("Verify handler = "+await verifyHandler())
  ...
  return (
    <div className="py-5">
      ...
      {success ? (
        ...
        <div className="m-auto min-h-screen lg:flex lg:items-center lg:justify-center">
          <div className="bg-white p-6 drop-shadow-2xl lg:p-16">
            <h3 className="py-3 text-4xl font-semibold">
              Blessed Hope Maternity and Lying-in Clinic
            </h3>
            <h3 className="mt-7 mb-5 text-2xl">Appointment Form</h3>
                ...
                <div className="flex flex-col items-end lg:flex-row">
                  ...
                  <div className="mt-4 w-full lg:ml-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <button
                        onClick={triggerTime}
                        className="mt-2 min-w-requestBtn rounded-md rounded-l-none border border-primary bg-primary px-4 py-2 text-white "
                      >
              ...
              {submitOnProgress ? (
                ...
                <div className="flex">
                  <Link href="../login">
                    <button
                      onClick={() => {}}
                      className="ml-4 rounded-md  bg-gray-500 px-4 py-2 text-white "
                    >
